(() => {
  ...
  new e("max").init();
  const t = { inputMaskModule: null, selectModule: null };
  let s = {
    getErrors(e) {
      let t = 0,
        ...
        setTimeout(() => {
          ...
          for (let e = 0; e < i.length; e++) {
            ...
            t.parentElement.classList.remove("_form-focus"),
              ...
              s.removeError(t),
              (t.value = t.dataset.placeholder);
          }
          let a = e.querySelectorAll(".checkbox__input");
          if (a.length > 0)
  ...
  function a(e = {}, t = {}) {
    Object.keys(t).forEach((s) => {
      void 0 === e[s]
        ? (e[s] = t[s])
        : i(t[s]) && i(e[s]) && Object.keys(t[s]).length > 0 && a(e[s], t[s]);
    });
  }
  const r = {
    body: {},
  ...
  const A = {
    ...
    updateSlides: function () {
      ...
      "string" == typeof x &&
        ...
        i.centeredSlides &&
          i.cssMode &&
          (f(a, "--swiper-centered-offset-before", ""),
          f(a, "--swiper-centered-offset-after", ""));
        ...
        (a = parseInt(
          ...
          t.centeredSlides
            ? r < e.loopedSlides - i / 2 ||
              ...
              ? (e.loopFix(),
                (r = y(v(s, `${n}[data-swiper-slide-index="${a}"]`)[0])),
                d(() => {
                  e.slideTo(r);
                }))
              : e.slideTo(r)
  ...
  function _(e) {
    ...
    const y =
      s.params.loop && !(s.virtual && s.params.virtual.enabled) && !a.cssMode;
    if (!i.isMoved) {
      if (
  ...
  function B(e) {
    ...
    if (m > a.longSwipesMs) {
      ...
      "next" === t.swipeDirection &&
        (b >= a.longSwipesRatio
          ? t.slideTo(a.rewind && t.isEnd ? v : h + y)
          : t.slideTo(h)),
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = G.bind(e)),
            ...
            (e.onClick = F.bind(e)),
            (e.onLoad = j.bind(e)),
            V || (t.addEventListener("touchstart", R), (V = !0)),
            W(e, "on");
        },
  ...
  function ie({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function c(t) {
      if (!t.target.matches(se(e.params.pagination.bulletClass))) return;
      t.preventDefault();
      const s = y(t.target) * e.params.slidesPerGroup;
      ...
      "string" == typeof t.el &&
        ...
        s &&
          ...
          (e.params.uniqueNavElements &&
            ...
            s.length > 1 &&
              (s = s.filter((t) => S(t, ".swiper")[0] === e.el)[0])),
  ...
  function ae({ swiper: e, extendParams: t, on: s, emit: i, params: a }) {
    let r, l;
  ...
  function ne({ swiper: e, duration: t, transformElements: s, allSlides: i }) {
    ...
    !(function (e) {
      ...
      setTranslate: () => {
        ...
        for (let s = 0; s < t.length; s += 1) {
          ...
          (S.style.transform = y),
            (S.style.opacity = b),
            h.origin && (S.style.transformOrigin = b);
        }
      },
      setTransition: (t) => {
        ...
        s.forEach((e) => {
          ...
          ne({ swiper: e, duration: t, transformElements: s, allSlides: !0 });
      },
  ...
  function de() {
    const e = document.querySelector(".allowSlide").value;
    console.log(e);
    ...
    de(),
      document.querySelector(".swiper") &&
        new Z(".hero__slider", {
          ...
          allowSlideNext: parseInt(heroSlider.value),
          observer: !0,
          observeParents: !0,
          slidesPerView: 1,
          spaceBetween: 0,
          ...
          simulateTouch: !1,
          loop: !0,
          pagination: { el: ".hero__slider-pagging", clickable: !0 },
          navigation: {
            nextEl: ".hero-more .hero-more__item-next",
            prevEl: ".hero-more .hero-more__item-prev",
          },
          on: {},
        });
  });
  ...
  const pe = document.documentElement,
    ue = document.querySelector(".header"),
    me = document.querySelector(".nav-bar"),
    fe = document.querySelector(".hero-more");
  new IntersectionObserver(function (e, t) {
    e[0].isIntersecting
      ? (ue.classList.remove("_scroll"),
        me.classList.remove("_scroll"),
        fe.classList.remove("_scroll"))
      : (ue.classList.add("_scroll"),
        me.classList.add("_scroll"),
        fe.classList.add("_scroll"));
  }).observe(ue);
  const he = document.querySelector(".icon-menu"),
    ge = document.querySelector(".icon-menu-close");
  he &&
    he.addEventListener("click", () => {
      pe.classList.contains("menu-open") ||
        pe.classList.contains("lock") ||
        (pe.classList.add("menu-open"), pe.classList.add("lock"));
    }),
    ge &&
      ge.addEventListener("click", () => {
        pe.classList.contains("menu-open") &&
          pe.classList.contains("lock") &&
          (pe.classList.remove("menu-open"), pe.classList.remove("lock"));
      }),
    (function () {
